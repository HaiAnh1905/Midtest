...
import NewRelease from "./News";
import spy1 from "../imgs/spycarousel1.png";
import spy2 from "../imgs/spy_card 1.png";
import boruto from "../imgs/boruto-naruto-next-generations 1.png";
import AOT from "../imgs/attackontitan 1.png";
import Tsubasa from "../imgs/captsu_card 1.png";
import op from "../imgs/One-piece 1.png";
import aoshi from "../imgs/aoashi_card 1.png";
...
function App() {
  ...
  const [exploreAnime, setExploreAnime] = useState(movieData[0])
  // let mv = [...movieData[0]]
  // console.log(mv);
  return (
    <div className="container">
      ...
      <div className="explore">
        <Explore explore={exploreAnime}/>
      </div>
      {/* New realease */}
      <div className="news">
        <h1>New Release</h1>
        <div className="animeCard">
          {movieData.slice(1).map((movieName) => {
            return <NewRelease key={movieName.id}
            {...movieName} 
            changeExploreCard = {() => {
              setExploreAnime(movieName)
            }}
            imgCard={movieName} />;
          })}
        </div>
